...
@section('title', 'Add new contributor')
        ...
        <form id="creation-form">
            <div class="card-body">
                <div class="form-group mb-8">
                    <div class="alert alert-custom alert-default" role="alert">
                        ...
                        <div class="alert-text">
                            After adding new contributor <code>Contributer</code> all permissions will given for new contributor
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="email" value="" id="email"
                            placeholder="Enter contributor email: almadar@ot.com.sa" />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group">
                    <label>Contributor Image Profile</label>
                    <div></div>
